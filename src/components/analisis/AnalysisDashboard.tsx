      ...
      >
        ...
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-2 shrink-0">
            ...
            <span className="font-black text-[11px] uppercase tracking-wider text-[rgb(25,79,112)] dark:text-teal-400">
        ...
        <div className="flex flex-wrap items-center gap-2 pt-2 border-t" style={{ borderColor: 'var(--border-faint)' }}>
          ...
          <div 
            className="ml-auto text-[10.5px] font-black uppercase tracking-wider px-3 py-1 rounded-full text-white shadow-xs"
        ...
        <div className="flex items-center gap-1 overflow-x-auto no-scrollbar">
          <button
            ...
            className={`px-4 py-2.5 font-black text-[11px] uppercase tracking-wider transition-all flex items-center gap-1.5 cursor-pointer border-b-2 ${
              activeTab === 'tren' 
                ? 'border-[rgb(25,79,112)] text-[rgb(25,79,112)] dark:text-teal-400 dark:border-teal-400' 
            ...
            {(['kejadian', 'meninggal', 'pengungsi', 'rumah'] as const).map(metric => (
              <button
                ...
                className={`px-2.5 py-1 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-all cursor-pointer ${
                  trendMetric === metric 
                    ? 'bg-[rgb(25,79,112)] text-white shadow-xs' 
        ...
        {activeTab === 'tabel' && (
          ...
          >
            ...
            <div className="flex items-center justify-between text-[10.5px] text-slate-400 font-medium pt-1 px-1">
              ...
              <span className="font-bold text-[rgb(25,79,112)] dark:text-teal-400">Urutan Prioritas Kejadian Tertinggi</span>
            </div>
          </div>
        )}
