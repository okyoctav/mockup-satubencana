              ...
              >
                <div>
                  ...
                  <div className="p-6 space-y-3">
                    ...
                    <Link href={`/blog/${featuredPost.id}`}>
                      <h4 className="text-base font-bold text-slate-900 dark:text-white leading-snug group-hover:text-[#0EA5E9] transition-colors cursor-pointer">
                        {post.title}
                      </h4>
                    </Link>
                ...
                <div className="p-6 pt-0 flex items-center justify-between border-t border-slate-100 dark:border-slate-800/60 mt-4">
                  ...
                  <Link
                    href={`/blog/${featuredPost.id}`}
                    className="pt-4 text-xs font-bold text-[#0EA5E9] hover:underline flex items-center gap-1"
                  >
                    <span>Baca</span>
